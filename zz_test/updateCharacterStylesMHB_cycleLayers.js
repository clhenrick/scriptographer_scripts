...
*******************/
var docLayer = document.layers

/* create a loop that cycles through document layers and runs a function to update matching layers' text
for (k=0, k<docLayer.length, k++) {
	if (docLayer.length != 0) {
	updateLayers(docLayer[k]);
	}
}
*/
